...
test('it should not be able create new folder if user already folder with this name', async () => {
  const inputSignUp = {
    username: 'wftDeNome',
  ...
  await createNewFolder.handle(inputCreateFolder)
  await expect(() => createNewFolder.handle(inputCreateFolder)).rejects.toThrow(
...
test('it should be able create new folder', async () => {
  ...
  expect(outputCreateFolder.folderId).toBeDefined()
})
