...
describe('Suite test for testing folder entity', () => {
  let folder: {
    id: string
    name: string
    thumbnail: string
  ...
  test('it should not be able to create a new folder if thumbnail not was informed', () => {
    ...
    ).toThrow('Thumbnail não foi fornecido')
  })
